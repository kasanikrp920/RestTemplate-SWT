...
public class SearchResultOnBookTitle {

    String available;
    String ISBN;
    String author;
    String title;
    public SearchResultOnBookTitle(Display display, String s, String source) {
        final String btnSource = source;
        final String bookTitle = s;
                ...
                public void widgetSelected(SelectionEvent e) {
                    ...
                    try {
                        ...
                        if(avail==0){
                            ...
                            new BorrowerGui(d,ISBN,title,author,available);
                            shell.dispose();
                        }
                    } catch (Exception a) {
